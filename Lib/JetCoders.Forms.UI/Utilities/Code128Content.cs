...
namespace JetCoders.Forms.UI.GenCode128
{
   public enum CodeSet
   {
      CodeA
	...
	public class Code128Content
	{
      ...
      private int[] StringToCode128( string AsciiData )
      {
         ...
         var codes = new ArrayList(asciiBytes.Length + 3) {Code128Code.StartCodeForCodeSet(currcs)}; // assume no codeset changes, account for start, checksum, and stop
